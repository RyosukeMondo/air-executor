...
class PythonStaticAnalyzer:
    ...
    def analyze(self, project_path: str) -> AnalysisResult:
        ...
        result = AnalysisResult(language="python", phase="static", project_path=project_path)
